...
public class Programa {
	...
	public static void main(String[] args) throws Exception {
		...
		for (Aparcamiento a : aparcamientos)
			a.setUrl("ciudades/" + ciudad.getId() + "/aparcamientos/"+a.getId());
		...
		for (Aparcamiento a : aparcamientos2) {
			a.setId(new ObjectId().toString());
			a.setUrl("ciudades/" + malaga.getId() + "/aparcamientos/"+a.getId());
		...
		for (Aparcamiento a : aparcamientos3)
			a.setUrl("ciudades/" + sta.getId() + "/aparcamientos/"+a.getId());
		...
		for (Aparcamiento a : aparcamientos4)
			a.setUrl("ciudades/" + vg.getId() + "/aparcamientos/"+a.getId());
