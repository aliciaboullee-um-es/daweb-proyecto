...
async function cargarAparcamientos(idSitio){
  ...
  let markers=[];
  let sitio = await fetch('http://localhost:8080/api/ciudades/5d36d5c2-241a-4148-aec9-457d35c6aa94/sitiosInteres/'+idSitio,{
    method: 'GET',
    headers: {
      'Access-Control-Allow-Origin': '*',
      'accept': 'application/json'
  ...
  .then(async function(res){
    ...
    let aparcamientos = await fetch('http://localhost:8080/api/ciudades/5d36d5c2-241a-4148-aec9-457d35c6aa94/sitiosInteres/'+sitio['id']+'/aparcamientos',{
      method: 'GET',
      headers: {
        'Access-Control-Allow-Origin': '*',
        'accept': 'application/json'
