function getSitiosInteres(){
  ...
  fetch('http://localhost:8080/api/ciudades/7ac16116-14cc-4caa-b739-3597bbf00f28/sitiosInteres',{
    method: 'GET',
    headers: {
...
async function initMap() {
  ...
  let sitios = await fetch('http://localhost:8080/api/ciudades/7ac16116-14cc-4caa-b739-3597bbf00f28/sitiosInteres',{
    method: 'GET',
    headers: {
      'Access-Control-Allow-Origin': '*',
      'accept': 'application/json'
...
async function cargarAparcamientos(idSitio){
  ...
  let markers=[];
  let sitio = await fetch('http://localhost:8080/api/ciudades/7ac16116-14cc-4caa-b739-3597bbf00f28/sitiosInteres/'+idSitio,{
    method: 'GET',
    headers: {
      'Access-Control-Allow-Origin': '*',
      'accept': 'application/json'
  ...
  .then(async function(res){
    ...
    let aparcamientos = await fetch('http://localhost:8080/api/ciudades/7ac16116-14cc-4caa-b739-3597bbf00f28/sitiosInteres/'+sitio['id']+'/aparcamientos',{
      method: 'GET',
      headers: {
        'Access-Control-Allow-Origin': '*',
        'accept': 'application/json'
